...
CREATE TABLE `log_msg` (
  ...
  PRIMARY KEY (`id`),
  KEY `Index 2` (`src`)
) ENGINE=InnoDB AUTO_INCREMENT=226270 DEFAULT CHARSET=utf8 COLLATE=utf8_estonian_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=424 DEFAULT CHARSET=utf8 COLLATE=utf8_estonian_ci;
